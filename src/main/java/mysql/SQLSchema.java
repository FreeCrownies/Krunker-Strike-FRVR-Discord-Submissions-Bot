    ...
    static void onCreate() throws SQLException, InterruptedException {
        ...
        DBMain.getInstance().update(
                "CREATE TABLE IF NOT EXISTS `Counter` (" +
                        ...
                        "`reaction_emote_correct` varchar(64), " +
                        "`reaction_emote_wrong` varchar(64), " +
                        "PRIMARY KEY (`guildId`) " +
                        ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;"
        );
        ...
        DBMain.getInstance().asyncUpdate(
                "CREATE TABLE IF NOT EXISTS `TicketPanelOverflowCategory` (" +
                        "`panel_id` bigint unsigned NOT NULL, " +
        ...
        DBMain.getInstance().asyncUpdate(
                "CREATE TABLE IF NOT EXISTS `MessageRaffleEntry` (" +
                        ...
                        "`ken_multiplier` tinyint(1) unsigned NOT NULL, " +
        ...
        DBMain.getInstance().asyncUpdate(
                "CREATE TABLE IF NOT EXISTS `MessageRafflePrize` (" +
                        "`guild_id` bigint unsigned NOT NULL, " +
                        "`message_raffle_id` bigint unsigned NOT NULL, " +
                        "`prize_id` int unsigned NOT NULL, " +
                        "`name` varchar(150) NOT NULL, " +
                        "`winners` int unsigned NOT NULL, " +
                        "PRIMARY KEY (`message_raffle_id`, `prize_id`)"
                        + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;"
        );
        ...
        DBMain.getInstance().update(
                "CREATE TABLE IF NOT EXISTS `PremiumGuild` (" +
                        ...
                        "`is_permission_sync` tinyint(1) NOT NULL DEFAULT '1', " +
                        "PRIMARY KEY (`guild_id`) " +
                        ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;"
        );
        ...
        DBMain.getInstance().asyncUpdate(
                "CREATE TABLE IF NOT EXISTS `SpaceMine` (" +
                        "`guild_id` bigint unsigned NOT NULL, " +
                        "`user_id` bigint unsigned NOT NULL, " +
                        "`id` bigint unsigned NOT NULL, " +
                        "`planet_id` bigint unsigned NOT NULL, " +
                        "`mine_type` tinyint(1) unsigned NOT NULL, " +
        ...
        DBMain.getInstance().asyncUpdate(
                "CREATE TABLE IF NOT EXISTS `CasinoStats` (" +
        ...
        DBMain.getInstance().asyncUpdate(
                "CREATE TABLE IF NOT EXISTS `TicketSelectionSlot` (" +
                        "`guild_id` bigint unsigned NOT NULL," +
                        "`id` bigint unsigned NOT NULL, " +
                        "`custom_message_id` bigint unsigned NOT NULL, "+
                        "PRIMARY KEY (`id`) " +
        ...
        DBMain.getInstance().asyncUpdate(
                "CREATE TABLE IF NOT EXISTS `TicketSelectionSlotPanel` (" +
                        "`guild_id` bigint unsigned NOT NULL, " +
                        "`panel_id` bigint unsigned NOT NULL, " +
                        "`slot_id` bigint unsigned NOT NULL, " +
                        "PRIMARY KEY (`panel_id`, `slot_id`) " +
                        ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;"
        );

...
public abstract class ListAbstract extends Command implements OnButtonListener, OnStringSelectMenuListener {
    ...
    private static final String BUTTON_ID_JUMP_TO = "jumpto";
    ...
    public boolean onButton(@NotNull ButtonInteractionEvent event) throws Throwable {
        switch (event.getComponentId()) {
            ...
            case BUTTON_ID_JUMP_TO -> {
                String textId = "page";
                String textLabel = TextManager.getString(getLocale(), TextManager.GENERAL, "list_jump_to_label", String.valueOf(getPageSize()));
                ...
                String title = TextManager.getString(getLocale(), TextManager.GENERAL, "list_jump_to");
    ...
    public EmbedBuilder draw(@NotNull User member) throws Throwable {
        ...
        if (size > entriesPerPage) {
            actionRows.add(ActionRow.of(
                    ...
                    Button.of(ButtonStyle.PRIMARY, BUTTON_ID_JUMP_TO, TextManager.getString(getLocale(), TextManager.GENERAL, "list_jump_to")),
